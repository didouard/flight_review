...
from tornado_handlers.show import ShowHandler

from tornado_handlers.shows import ShowsHandler
...
parser.add_argument(
    "-s", "--show", dest="show", action="store_true", help="Open browser on startup"
)
parser.add_argument(
    "--use-xheaders",
    action="store_true",
...
parser.add_argument(
    "--port", type=int, action="store", help="Port to listen on", default=None
)
parser.add_argument(
    "--address", action="store", help="Network address to listen to", default=None
)
parser.add_argument(
    "--host",
    action="append",
...
if args.address is not None:
    server_kwargs["address"] = args.address
