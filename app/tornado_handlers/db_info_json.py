...
class DBInfoHandler(tornado.web.RequestHandler):
    ...
    def get(self, *args, **kwargs):
        ...
        cur.execute(
            ...
            "Source, Feedback, Type, OriginalFilename from Logs where Public = 1"
        )
        ...
        for db_tuple in db_tuples:
            ...
            db_data.original_filename = db_tuple[10]
            ...
            jsondict["airframe_name"] = (
                airframe_data.get("name", "") if airframe_data is not None else ""
            )
            jsondict["airframe_type"] = (
                airframe_data.get("type", jsondict["sys_autostart_id"])
                if airframe_data is not None
                else jsondict["sys_autostart_id"]
            )
